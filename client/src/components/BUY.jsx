...
export const BUY = ({buyingPage,setbuyingPage,id,price}) => {
        ...
        <div className=' h-auto bg-white shadow  rounded-xl'>
            ...
            <div className='flex flex-col p-2 space-y-2 '>
                ...
                className='outline-none border-2 border-gray-200 p-2 rounded-xl w-fit' type="number" placeholder='postal code' />
                 <span>Quantity:</span>
                 <input 
                    onChange={(e)=>setBuyerInfo({...BuyerInfo,qty:e.target.value,price:e.target.value*price})} value={BuyerInfo.qty}
                className='outline-none border-2 border-gray-200 p-2 rounded-xl w-fit' type="number" placeholder='quantity' />
                <h1 className='text-green-600 p-4 font-bold font-xl'>
                    {price*BuyerInfo.qty}$
                </h1>
